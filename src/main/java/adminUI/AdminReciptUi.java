...
public class AdminReciptUi {
    public AdminReciptUi(String appointmentNumber,String date, String time, String doctorNamec, String patientName, String address, String contact, String age, String gender) {
        ...
        print.addActionListener(btn->{
            if(flag.get()){
                ...
                if(flag1){
                    ...
                    frame.dispose();
                    new AdminBillUi(invoiceNumberBox.getText(),appointmentNumber,date,time,doctorNamec,fees,service_charges,totalAmt,patientName,address,contact,age,gender);
                }
                else{
