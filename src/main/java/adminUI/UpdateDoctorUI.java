...
public class UpdateDoctorUI {
    public UpdateDoctorUI(Doctor doctor){
        ...
        updateDoctorButton.setBounds(530,400,200,40);
        ...
        updateDoctorButton.addActionListener(btn->{
            ...
            String doctorCon=doctor.getContact();
            ...
            if(!name.equalsIgnoreCase("") && !address.equalsIgnoreCase("")
                ...
                DoctorService.doctorUpdated(doctorCon,name,address,specialization,contact,fee);
                new adminUI.DoctorUI();
                JOptionPane.showMessageDialog(frame,"DOCTOR SUCCESSFULLY UPDATED");
                frame.dispose();
        ...
        bottomPanel.add(updateDoctorButton);
